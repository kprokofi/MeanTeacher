...
export OUTPUT_PATH="/local/kprokofi/segmentation/output_voc_person_proto_only_sup_loss"
...
# export volna="/home/kprokofi/datasets/datasets"
# export OUTPUT_PATH="/local/kprokofi/segmentation/output_disk_proto_only_sup_loss"
# export snapshot_dir=$OUTPUT_PATH/snapshot
# mkdir $OUTPUT_PATH
...
# export OUTPUT_PATH="/local/kprokofi/segmentation/output_kvasir_proto_only_sup_loss"
# export snapshot_dir=$OUTPUT_PATH/snapshot
# mkdir $OUTPUT_PATH
