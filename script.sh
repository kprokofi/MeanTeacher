...
# export OUTPUT_PATH="/local/kprokofi/segmentation/output_city_4_proto_KMean"
...
# export volna="/home/kprokofi/datasets/datasets"
# export OUTPUT_PATH="/local/kprokofi/segmentation/output_city_proto_KMean"
# export snapshot_dir=$OUTPUT_PATH/snapshot
# mkdir $OUTPUT_PATH
...
export volna="/home/kprokofi/datasets/datasets"
export OUTPUT_PATH="/local/kprokofi/segmentation/output_disk_proto_KMean"
export snapshot_dir=$OUTPUT_PATH/snapshot
mkdir $OUTPUT_PATH
...
val_linear.txt
export volna="/home/kprokofi/datasets/datasets"
export OUTPUT_PATH="/local/kprokofi/segmentation/output_voc_person_proto_KMean"
export snapshot_dir=$OUTPUT_PATH/snapshot
mkdir $OUTPUT_PATH
...
export OUTPUT_PATH="/local/kprokofi/segmentation/output_kvasir_proto_KMean"
export snapshot_dir=$OUTPUT_PATH/snapshot
mkdir $OUTPUT_PATH
...
export volna="/home/kprokofi/datasets/datasets"
export OUTPUT_PATH="/local/kprokofi/segmentation/output_fish_proto_KMean"
export snapshot_dir=$OUTPUT_PATH/snapshot
mkdir $OUTPUT_PATH
