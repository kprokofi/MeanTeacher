...
def get_train_loader_city(engine, dataset, train_source, config, unsupervised=False, collate_fn=None):
...
class CityScape(BaseDataset):
    ...
    def __init__(self, setting, split_name, preprocess=None,
                 file_length=None, training=True, unsupervised=False, **kwargs):
